...
type Client struct {
	...
	// GenerateWeeklyBrief Doer is the HTTP client used to make requests to the
	...
	// ShareWeeklyBriefToChat Doer is the HTTP client used to make requests to the
	// share-weekly-brief-to-chat endpoint.
	ShareWeeklyBriefToChatDoer goahttp.Doer
...
// GenerateWeeklyBrief returns an endpoint that makes HTTP requests to the
// committee-service service generate-weekly-brief server.
func (c *Client) GenerateWeeklyBrief() goa.Endpoint {
	var (
		encodeRequest  = EncodeGenerateWeeklyBriefRequest(c.encoder)
		decodeResponse = DecodeGenerateWeeklyBriefResponse(c.decoder, c.RestoreResponseBody)
	)
	return func(ctx context.Context, v any) (any, error) {
		req, err := c.BuildGenerateWeeklyBriefRequest(ctx, v)
		if err != nil {
			return nil, err
		}
		err = encodeRequest(req, v)
...
// UpdateCurrentWeeklyBrief returns an endpoint that makes HTTP requests to the
// committee-service service update-current-weekly-brief server.
func (c *Client) UpdateCurrentWeeklyBrief() goa.Endpoint {
	var (
		encodeRequest  = EncodeUpdateCurrentWeeklyBriefRequest(c.encoder)
		decodeResponse = DecodeUpdateCurrentWeeklyBriefResponse(c.decoder, c.RestoreResponseBody)
	)
	return func(ctx context.Context, v any) (any, error) {
		req, err := c.BuildUpdateCurrentWeeklyBriefRequest(ctx, v)
		if err != nil {
			return nil, err
		}
		err = encodeRequest(req, v)
		...
		resp, err := c.UpdateCurrentWeeklyBriefDoer.Do(req)
		if err != nil {
			return nil, goahttp.ErrRequestError("committee-service", "update-current-weekly-brief", err)
		}
		return decodeResponse(resp)
	}
}

// ShareWeeklyBriefToChat returns an endpoint that makes HTTP requests to the
// committee-service service share-weekly-brief-to-chat server.
func (c *Client) ShareWeeklyBriefToChat() goa.Endpoint {
	var (
		encodeRequest  = EncodeShareWeeklyBriefToChatRequest(c.encoder)
		decodeResponse = DecodeShareWeeklyBriefToChatResponse(c.decoder, c.RestoreResponseBody)
	)
	return func(ctx context.Context, v any) (any, error) {
		req, err := c.BuildShareWeeklyBriefToChatRequest(ctx, v)
		if err != nil {
			return nil, err
		}
		err = encodeRequest(req, v)
		...
		resp, err := c.ShareWeeklyBriefToChatDoer.Do(req)
		if err != nil {
			return nil, goahttp.ErrRequestError("committee-service", "share-weekly-brief-to-chat", err)
		}
		return decodeResponse(resp)
	}
}
